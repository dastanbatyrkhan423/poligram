...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        company, created = CompanyInfo.objects.get_or_create(
            name="ТОО «Poligram»",
            defaults={
                'short_description': 'ТОО «Poligram» выполняет полный комплекс строительно-монтажных, отделочных и инженерных работ 1 категории',
                'full_description': 'Компания на рынке 19 лет. ТОО «Poligram» выполняет полный комплекс строительно-монтажных, отделочных и инженерных работ 1 категории.',
                'founded_year': 2006,
